...
1. [C_18 Operators in C - Part 6 | Bitwise Operators | C Programming Tutorials](https://www.youtube.com/watch?v=egUyaWtsQc0&ab_channel=Jenny%27sLecturesCSIT)
...
6. [Endianness](./100-get_endianness.c) : A function that checks the endianness.
	...
	- Confirm your architecture version:
		...
		Architecture:          x86_64 - 64bit machine
